...
<html>
    ...
    <meta name="description" content="Analyzing new cards from Modern Horizons and their potential in Modern Death and Taxes and Eldrazi and Taxes lists.">
    <meta name="keywords" content="Magic the Gathering, modern, Modern Horizons, death and taxes, dnt, modern dnt, ent, eldrazi and taxes, Giver of Runes, Horizon Canopy, Silent Clearing, Ranger-Captain of Eos, Unsettled Mariner">
    

        <title>Spice Space 5- Modern Horizons Cards</title>
    ...
    <body class="homePage" onload="loadScript()">
            ...
            <div class="container-fluid body-div" id="content">
                <div class="jumbotron">
                    <h1>Spice Space #5: Modern Horizons Cards</h1>
                </div>
            <br>
            <br>
            <div class="row">
            ...
            <script src="/autolists/autolist_c.js"></script>
