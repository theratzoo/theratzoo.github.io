...
<html>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <title>Mulligan Game Archives- Game 3</title>
        ...
        <script>
            function loadScript() {
                ...
                var completed3 = localStorage.getItem('completed3');
                if (completed || completed3) {
    ...
    <body class="homePage" onload="loadScript()">
            ...
            <br>
            <div class="jumbotron">
                <h1>Mulligan Game Archives: Game #3</h1>
            </div>
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/sftpRHy.png" alt="hand1"><br>
    <div class="row">
      <br>
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/cAK7eBs.png" alt="hand2"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs Jund</h3>
    <img class="mullImg" src="https://i.imgur.com/Yc7gO4f.png" alt="hand3"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. Mardu Pyromancer</h3>
    <img class="mullImg" src="https://i.imgur.com/jjwJBmo.png" alt="hand4"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. BR Hollow One</h3>
    <img class="mullImg" src="https://i.imgur.com/pIhu9fY.png" alt="hand5"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/Fs3QnEA.png" alt="hand6"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/Ksijz0K.png" alt="hand7"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/TpfEJUe.png" alt="hand8"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. BR Bridgevine</h3>
    <img class="mullImg" src="https://i.imgur.com/J5TgDva.png" alt="hand9"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/ayn7yY1.png" alt="hand10"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<input name="mgpage" value="3" style="display:none"><span value="3" style="display:none">3</span>
</form>
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    localStorage.setItem('completed3', true);
