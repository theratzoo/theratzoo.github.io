...
<html>
    ...
    <meta name="keywords" content="Magic the Gathering, MtG, mulligan, keep, Mulligan Game, keepormull, vote, Modern, death and taxes, dnt, modern dnt, ent, eldrazi and taxes, taxes, hatebears">
        ...
        <title>Mulligan Game Archives- Game 7</title>
        ...
        <script>
            function loadScript() {
                var completed = localStorage.getItem('completed7');
                if (completed) {
    ...
    <body class="homePage" onload="loadScript()">
            ...
            <div class="jumbotron" id="mg">
              <h1>Mulligan Game Archives: Game #7</h1>
              
            </div>
            <h3><a href="/decklists/2_3">Decklist</a></h3>
            <div id="endMsg" style="visibility:hidden;">
                <h2>You have already submitted a response for this Mulligan Game.</h2>
            </div>
            <form id="regForm" method="post" action="newarchivemulliganresults.php">
...
<div class="tab">
    <h3>On the draw vs. Colorless Eldrazi</h3>
    <img class="mullImg" src="https://i.imgur.com/bR4mq6n.png" alt="hand1"><br>
    <div class="row">
      <br>
...
<div class="tab">
    <h3>On the draw vs. Jund</h3>
    <img class="mullImg" src="https://i.imgur.com/j2PDVQG.png" alt="hand2"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/gBFwJGt.png" alt="hand3"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. Jund</h3>
    <img class="mullImg" src="https://i.imgur.com/3aPYKK9.png" alt="hand4"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. Humans</h3>
    <img class="mullImg" src="https://i.imgur.com/esZj3tF.png" alt="hand5"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/pNj9ZP6.png" alt="hand6"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/cvidvfk.png" alt="hand7"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. KCI</h3>
    <img class="mullImg" src="https://i.imgur.com/3KCfzb7.png" alt="hand8"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/znLQjmH.png" alt="hand9"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/kDQq9Qy.png" alt="hand10"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<hr>
            ...
            <div class="panel-group" id="accordion">
              <div class="panel panel-format">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    ...
                    DC #1: On the draw vs. Colorless Eldrazi</a>
                  </h4>
                </div>
                  ...
                  <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <ul>
                                <li>4 Aether Vial </li>
                                <li>1 Remorseful Cleric </li>
                                <li>1 Thalia, Guardian of Thraben </li>
                                <li>2 Wall of Omens </li>
                            </ul>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <ul>
                                <li>1 Aether Vial </li>
                                <li>1 Path to Exile </li>
                                <li>2 Flickerwisp </li>
                                <li>2 Thought-Knot Seer </li>
                            </ul>
                        </div>
                    </div>
                  </div>
              ...
              <div class="panel panel-format">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a id="dc10" data-toggle="collapse" data-parent="#accordion" href="#collapse8">
                    DC #10: On the play vs. Dredge</a>
                  </h4>
                </div>
                  ...
                  <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h3>Out:</h3>
                            <ul>
                                <li>2 Path to Exile </li>
                                <li>3 Flickerwisp </li>
                                <li>1 Thought-Knot Seer </li>
                            </ul>
                        </div>
                    </div>
                  </div>
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    localStorage.setItem('completed7', true);
