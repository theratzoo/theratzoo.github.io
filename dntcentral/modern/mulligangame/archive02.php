...
<html>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <title>Mulligan Game Archives- Game 2</title>
        ...
        <script>
            function loadScript() {
                ...
                var completed = localStorage.getItem('completed2');
                if (completed) {
    ...
    <body class="homePage" onload="loadScript()">
            ...
            <br>
            <div class="jumbotron">
                <h1>Mulligan Game Archives: Game #2</h1>
            </div>
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/4YqV1Q1.png" alt="hand1"><br>
    <div class="row">
      <br>
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/unRs4Z6.png" alt="hand2"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/pu1MG2x.png" alt="hand3"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/En1ZqPp.png" alt="hand4"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. Tron</h3>
    <img class="mullImg" src="https://i.imgur.com/FVszlgl.png" alt="hand5"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/Ics2ay2.png" alt="hand6"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/EFB51Aj.png" alt="hand7"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. UW Spirits deck</h3>
    <img class="mullImg" src="https://i.imgur.com/c4z6bDe.png" alt="hand8"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/MFaxLTi.png" alt="hand9"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/aqa0MoN.png" alt="hand10"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<input name="mgpage" value="2" style="display:none"><span value="2" style="display:none">2</span>
</form>
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    localStorage.setItem('completed2', true);
