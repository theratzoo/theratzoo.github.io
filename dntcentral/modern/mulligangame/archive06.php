...
<html>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <title>Mulligan Game Archives- Game 6</title>
        ...
        <script>
            function loadScript() {
                var completed = localStorage.getItem('completed6');
                if (completed) {
    ...
    <body class="homePage" onload="loadScript()">
           ...
           <div class="jumbotron">
                <h1>Mulligan Game Archives: Game #6</h1>
            </div>
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/5Op0cFD.png" alt="hand1"><br>
    <div class="row">
      <br>
...
<div class="tab">
    ...
    <img class="mullImg" src="https://i.imgur.com/0eORfDn.png" alt="hand2"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/Zq6DwqE.png" alt="hand3"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/Oll3aSX.png" alt="hand4"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/a2xLmjs.png" alt="hand5"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/GRfG7wt.png" alt="hand6"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/dLQ6x4W.png" alt="hand7"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/XeQGA9u.png" alt="hand8"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the draw vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/kZ1l9oz.png" alt="hand9"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<div class="tab">
    <h3>On the play vs. unknown deck</h3>
    <img class="mullImg" src="https://i.imgur.com/G905vUm.png" alt="hand10"><br>
    <div class="row">
      <br>
        <div class="col-sm-1"></div>
        <div class="col-sm-5">
...
<input name="mgpage" value="6" style="display:none"><span value="6" style="display:none">6</span>
</form>
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    localStorage.setItem('completed6', true);
