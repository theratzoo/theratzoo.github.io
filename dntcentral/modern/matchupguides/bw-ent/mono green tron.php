...
<html>
    ...
    <meta name="keywords" content="Magic the Gathering, modern, death and taxes, dnt, modern dnt, ent, bw eldrazi and taxes, green, karn, tron, matchup, thalia, leonin arbiter">
    ...
    <body class="homePage" onload="loadScript()">
            ...
            <div class="jumbotron">
                <div class="row">
                    <div class="col-sm-9">
                        <h1>Matchup Guide: Mono Green Tron</h1>
                    </div>
                    <div class="col-sm-3">
          ...
          <!--GO-->
                ...
                <br>
                <p>Flickerwisp is strong if used to its full potential. As a 3/1 flyer for three mana, Flickerwisp is underwhelming. However, in conjunction with other blink creatures or an Aether Vial, Flickerwisp provides key disruption against the opponent. As long as Flickerwisp can enter the battlefield on your end step, it can take the opponent off of one of their Tron lands, slowing them down considerably for a turn. In addition, if blinked multiple times (i.e. Eldrazi Displacer activations), Flickerwisp can lock the opponent off of their Tron mana.</p>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <img src="https://gatherer.wizards.com/Handlers/Image.ashx?name=Thought-Knot+Seer&type=card" class="cardImgMUG" alt="Thought-Knot Seer Angel">
                    </div>
                </div>
                <br>
                <p>Tidehollow Sculler is a strong card against Mono-Green Tron if played early. If Tidehollow Sculler is cast turn two on the play, you can exile the opponent's Sylvan Scrying. Otherwise, Tidehollow Sculler is usually taking a removal spell such as Walking Ballista or Oblivion Stone, or it is taking one of their expensive threats. Even though all these cards are "expensive", thanks to Tron lands, the opponent can easily cast them. Thus, playing Tidehollow Sculler early is important. Many games against Tron come down to the opponent's top decks, as assembling Tron can dry them of their resources quicker than one would expect. Also, in general, Mono-Green Tron mulligans a lot, making discard spells like Tidehollow Sculler more impactful. Likewise, Thought-Knot Seer can be a valuable card against Mono-Green Tron, as long as you can play it early on. Thought-Knot Seer can help keep them off Tron, by exiling an Expedition Map or Sylvan Scrying from their hand. However, in order to do this, Thought-Knot Seer would have to be played very early on, so it is most common for it to take away one of their payoff spells. Removal spells such as Spacial Contortion and Dismember are also common targets for Thought-Knot Seer's ability. Even if it cannot take a high-impact card, Thought-Knot Seer provides a useful body. It dodges Spacial Contortion and Ugin, the Spirit Dragon's abilities. All in all, both Tidehollow Sculler and Thought-Knot Seer are solid cards against Mono-Green Tron, so long as they are played in the first few turns.</p>
                <br>
                <div class="row">
                    <div class="col-6">
                ...
                <br>
                <p>Wasteland Strangler is very weak against Mono-Green Tron. None of Mono-Green Tron's creatures in the main deck have toughness of three or less (except for Walking Ballista when x=3, but that is irrelevant). Wasteland Strangler can shrink a Wurmcoil Engine or kill a post-board Thragtusk, but neither of these are very effective uses of the Eldrazi. Plus, the opponent's deck does not exile cards often, so there will be times where Wasteland Strangler cannot even exile something. That being said, one nice interaction with Wasteland Strangler is that it can get rid of a Tron land. This is achieved by Flickerwisp targeting a Tron land, then Wasteland Strangler putting that exiled land into the opponent's graveyard. Even if this results in one of our creatures dying, the exchange is well worth it. All in all, Wasteland Strangler is a very weak creature, as Mono-Green Tron lacks small targets for its -3/-3 ability</p>;
                <p>The final Eldrazi in Mono-White Eldrazi and Taxes, Eldrazi Displacer, is a solid creature, albeit a little situational. Eldrazi Displacer's blink ability can stop the opponent's Ulamog, the Ceaseless Hunger, Worldbreakers, and Wurmcoil Engines from attacking or blocking. Eldrazi Displacer can also get rid of Wurmcoil Engine and Thragtusk tokens. And on top of that, as it is a colorless creature, Eldrazi Displacer dodges colorless-only removal, such as Ugin, the Spirit Dragon's minus x and All is Dust. Eldrazi Displacer is a fine creature to attack the opponent with. On top of that, Eldrazi Displacer can blink Tidehollow Sculler and Thought-Knot Seer to take the opponent off of their top decks. All in all, Eldrazi Displacer is a fine, but niche, card against Mono-Green Tron.</p>
                <br>
                ...
                <br>
                <p>While I do not typically discuss the lands in matchup guides, this land is impactful enough against Tron that it warrants a discussion. Ghost Quarter is the best card against Tron, period. This card allows B/W Eldrazi and Taxes stop the opponent from achieving turn three Tron when we are on the draw. Furthermore, Ghost Quarter plus Leonin Arbiter significantly hurts the opponent. Not only are they losing a Tron land, but they are also getting farther away from paying Leonin Arbiter's tax. Ghost Quarter (with Leonin Arbiter) also makes it difficult for the opponent to hard cast their expensive spells. Even though it is rare to see a hard cast planeswalker, there are plenty where the fifth land for activating Oblivion Stone is achieved. In conclusion, Ghost Quarter is crucial to disrupting the Mono-Green Tron player's game plan.</p>
                ...
                <p>Aether Vial is very good with certain cards. As mentioned above, Aether Vial can lead to plays such as bringing in an unexpected Leonin Arbiter or flashing in Flickerwisp to get rid of a Tron land. It can also let a hand-disruptive creature such as Tidehollow Sculler or Thought-Knot Seer prevent the opponent from top-decking a nonland card. Path to Exile is more of a necessary evil than one might think. Aether Vial does get worse post-board, as Stony Silence is a clear nonbo with the one-mana artifact. Tron has a few large threats for Path to Exile in game one- Wurmcoil Engine and Ulamog, the Ceaseless Hunger. In addition, creatures such as Thought-Knot Seer, Thragtusk, and Worldbreaker come in post-board (or are played in some maindecks). There are many targets for Path to Exile, but it is still not a stellar card in the matchup. The goal in this matchup is to both disrupt the opponent and kill them as soon as possible. Usually, you want the opponent to be killed before the creatures hit the battlefield. Therefore, the Path to Exiles end up being counterintuitive to our strategy, as they are slowing us down. That being said, Path to Exile is necessary against Mono-Green Tron because B/W Eldrazi and Taxes cannot beat a Wurmcoil Engine or Ulamog, the Ceaseless Hunger in most scenarios.</p>
                <br>
                <div class="row">
                    <div class="col-6">
                ...
                <p>Against Mono-Green Tron, interaction against their strategy is what comes in. For this particular list of B/W Eldrazi and Taxes, the only card in the sideboard that does the job is Stony Silence. It turns off many of their cards- Expedition Map, Chromatic Sphere, Chromatic Star, Oblivion Stone, and Walking Ballista. Stony Silence is a nonbo with Aether Vial, but the upside more than outweighs this minor setback. Stony Silence simply turns off too many of Mono-Green Tron's cards to not bring it into the maindeck. In addition, Kambal, Consul of Allocation is a fine card to bring in. The majority of Mono-Green Tron's deck consists of non creature spells. Plus, many games have the opponent stuck at a low life total, making Kambal, Consul of Allocation's life loss quite impactful. Furthermore, Kambal, Consul of Allocation is replacing cards that are pretty much useless in comparison (will discuss later). When sideboarding, do not just look for stellar cards to put in- taking out bad cards and putting in slightly better ones is an important practice.</p>
                <br>
                <p>Other cards not in this B/W Eldrazi and Taxes sideboard that are fine to bring in include strong removal and hate spells. Oblivion Ring, Cast Down, and Leonin Relic-Warder are examples of cards that fulfill that requirement.</p>
                <br>
                ...
                <p>Wasteland Strangler, as discussed above, is a very bad card against Mono-Green Tron. Its ability does not destroy anything relevant, making it our worst card in the maindeck. Therefore, all three should be taken out from the maindeck. The next card to cut is Aether Vial. It is a nonbo with Stony Silence. That being said, a turn one Aether Vial is still quite powerful. In addition, the opponent typically brings in a few Nature's Claims, making Stony Silence less likely to stay on the board. Or, better yet, a turn one Aether Vial can bait out a Nature's Claim, leaving Stony Silence uncontested. Thus, only 1-2 Aether Vials should be cut from the deck. Since we are only bringing in four cards for this particular list, it is best to cut only one Aether Vial.</p>
                ...
                <h3>Conclusion</h3>
                <p>All in all, Mono-Green Tron is a favorable matchup for B/W Eldrazi and Taxes. Many of Eldrazi and Taxes's cards line up well against Mono-Green Tron's game plan. Leonin Arbiter and Ghost Quarter, in particular, ruin their plan, while the threats and other hate spells further strain the deck. Postboard, both sides get added interaction. Mono-Green Tron also gets extra threats, which can buy them the valuable time they need to cast their game-winning spells. The post-board games do get more difficult, but it is still favorable. Overall, the matchup is more of a coin flip than other Modern matchups, but B/W Eldrazi and Taxes can win on the draw easier than Mono-Green Tron can.</p>
                <br>
                <div class="panel-group" id="accordion4">
                        ...
                        <div id="collapse1d" class="panel-collapse collapse">
                          <div class="panel-body">
                              ...
                              <p>Mono-Green Tron is a favorable matchup for B/W Eldrazi and Taxes because of B/W Eldrazi and Taxes's disruption against the opponent's game plan. Taxing the opponent's mana base is important early on, but it is equally important to kill the opponent before they can simply cast their expensive spells. The first game is heavily based on whether you win or lose the die roll. If you go first, your hate bears will disrupt before the opponent can assemble Tron. Otherwise, they will be a turn too slow unless the opponent does not have turn three Tron. Still, it is easier to win on the draw as B/W Eldrazi and Taxes than for Mono-Green Tron to win on the draw, due to how well B/W Eldrazi and Taxes's cards line up against Tron. Leonin Arbiter and Ghost Quarter are especially valuable cards, but the aggressive creatures like Blade Splicer plus the other hatebears like Thalia, Guardian of Thraben, Tidehollow Sculler, and Thought-Knot Seer help B/W Eldrazi and Taxes disrupt and terminate the opponent.</p>
                              <br>
                              <p>When sideboarding, bring in disruptive spells and strong answers to Tron's game plan. Stony Silence is an auto-include, as it turns off many artifacts in their deck. Kambal, Consul of Allocation is also a fine card to bring in, as the incremental life-loss often matters. Spells that can remove artifacts, enchantments, or any creature can be brought in as well, such as Oblivion Ring, Cast Down, and Leonin Relic-Warder. The cards to cut Wasteland Strangler, as it is the weakest card, and 1-2 Aether Vials due to their nonbo with Stony Silence. The post-board games are a bit slower than game one, as both sides get access to more interaction. In addition, Mono-Green Tron has a few extra threats, such as Thought-Knot Seer and Thragtusk, which can further drag out games. Path to Exile, therefore, becomes more valuable to deal with the new threats. The core gameplay is still there, however- disrupt the opponent early on, taking them off of Tron, then playing creatures to kill them before they get to their expensive win conditions.</p>
                          </div>
                        </div>
                      </div>      
              </div>
