...
<html>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <title>Modern Variations- Mono White Eldrazi</title>
                    ...
                    <div class="col-sm-6">
                        <table class="table decklist table-condensed table-responsive">
                            <tbody>
                                ...
                                <tr><!-- thalia -->
                                    <td>4&emsp;<a href="" class="cellA" onclick="return false;" onmouseover="previewDeck(this.text)">Wall of Omens</a></td>
                                ...
                                <tr>
                                    <td>3&emsp;<a href="" class="cellA" onclick="return false;" onmouseover="previewDeck(this.text)">Eldrazi Displacer</a></td>
                               ...
                               <tr>
                                ...
                                <tr>
                                    <td>7&emsp;<a href="" class="cellA" onclick="return false;" onmouseover="previewDeck(this.text)">Plains</a></td>
                                </tr>
                                <tr>
                ...
                <table class="table table-condensed decklist table-responsive">
                    <tbody>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td>3&emsp;<a href="" class="cellA" onclick="return false;" onmouseover="previewDeck(this.text)">Burrenton Forge-Tender</a></td>
        ...
        <div class="panel-group" id="accordion8">
            ...
            <div class="row">
                ...
                <img class="entImg" src="https://cdna.artstation.com/p/assets/images/images/000/982/472/large/james-paick-127482.jpg?1437507210" alt="Eldrazi Temple">
                        ...
                        <div class="col-sm-3">
                            <img class="entCardImg" src="https://gatherer.wizards.com/Handlers/Image.ashx?name=Eldrazi%20Temple&type=card" alt="Eldrazi Temple">
                        </div>
            </div>

                </div>
                <hr>
        <h3>Other E&T Exclusive Main Deck Options</h3>
            <ul>
